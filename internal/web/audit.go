...
var auditLabels = map[string]string{
	...
	"auth.recovery":    "Code de secours utilisé",
	"auth.2fa.enable":  "Vérification en deux étapes activée",
	"auth.2fa.disable": "Vérification en deux étapes désactivée",
	"auth.key.add":     "Clé de sécurité enregistrée",
	"auth.key.remove":  "Clé de sécurité retirée",
	...
	"vault.recovered":  "Serveur rouvert avec le code de récupération",
	"vault.grant":      "Accès à un coffre accordé",
	"vault.revoke":     "Accès à un coffre retiré",
	"vault.share":      "Accès à un coffre accordé",
	"secret.share":     "Secret partagé",
	"secret.unshare":   "Partage d'un secret retiré",
	"share.grant":      "Secret partagé",
	"secret.pin":       "Secret restreint à une adresse",
	"secret.unpin":     "Restriction d'adresse retirée",
	"secret.import":    "Secrets importés",
